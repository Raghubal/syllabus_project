        ...
        <form action="" method="get" class="d-flex flex-row mb-3" style="margin: 2rem 0;">
                ...
                <select name="year" id="year" class="btn btn-secondary dropdown-toggle" aria-label="Default select example">>
                    ...
                    <?php if(!empty($data)): ?>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option><?php echo e($datas->year); ?></option>
            ...
            <div style="margin-right: 30px">
                <select name="semester" id="semester" class="btn btn-secondary dropdown-toggle" aria-label="Default select example">>
                    <option>semester</option>
                        <?php if(!empty($data)): ?>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option><?php echo e($datas->semester); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                </select>
            </div>
            ...
            <div style="margin-right: 30px">
                <select name="department" id="department" class="btn btn-secondary dropdown-toggle" aria-label="Default select example">>
                    ...
                    <?php if(!empty($data)): ?>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option><?php echo e($datas->department); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </select>
            </div>
            ...
            <div style="margin-right: 30px">
                <select name="program" id="program" class="btn btn-secondary dropdown-toggle" aria-label="Default select example">>
                    ...
                    <?php if(!empty($data)): ?>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option><?php echo e($datas->program); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </select>
            </div>
                ...
                <?php if(!empty($data)): ?>
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($datas->year); ?></td>
                            <td><?php echo e($datas->semester); ?></td>
                            <td><?php echo e($datas->department); ?></td>
                            <td><?php echo e($datas->program); ?></td>
                            <td>
...
<?php /**PATH C:\xampp\htdocs\syllabus\Syllabus\resources\views/filt.blade.php ENDPATH**/ ?>